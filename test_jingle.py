...
async def feeder(audi:ezaud.Audi):
	...
	await s(0.3)
	audi.add(audi.wg.Sine(dur=0.1,vol=0.03125,freq=ezaud.note("C4")))
	await s(0.1)
	audi.add(audi.wg.Sine(dur=0.3,vol=0.015625,freq=ezaud.note("E4")))
	await s(0.3)
	audi.add(audi.wg.Sine(dur=0.1,vol=0.0078125,freq=ezaud.note("C4")))
	await s(0.4)
